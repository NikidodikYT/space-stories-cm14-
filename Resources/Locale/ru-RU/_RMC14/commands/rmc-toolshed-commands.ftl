...
command-description-vehicleroundstart-current = Применяет пороговые значения для запуска раунда с участием транспортных средств на основе текущего количества подключенных игроков.
command-description-vehicleroundstart-test = Применяет пороговые значения для запуска раунда с участием транспортных средств на основе заданного количества игроков для тестирования.
